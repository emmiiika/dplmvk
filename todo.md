...
- [ ] **Landmark Extraction** Vytvoriť funkciu na extrakciu všetkých 21 bodov do numpy poľa.
- [ ] **Normalizácia (Translácia)** Odpočítať súradnice zápästia (ID 0) od všetkých ostatných bodov.
- [ ] **Normalizácia (Mierka)** Implementovať škálovanie podľa veľkosti dlane, aby sa vyrovnali rozdiely vo vzdialenosti od kamery.
